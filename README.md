...
npx shadcn@latest add button breadcrumb card checkbox dropdown-menu input label popover select separator table textarea sonner skeleton carousel
```
...
SK: Account password: Sergekol1!
SK: Database password: 5oPOCpB37zyGwqBz
...
```sh
# SK - from https://www.prisma.io/docs/guides/nextjs
...
### SK: Connect Supabase with Prisma

(moved up from the original readme, changed)

- add to .env

SK:

- Open supabase, log in, click <Connect> button.
- Select tab [ORMs], then Prisma
- Copy the text to .env,
- Replace [YOUR-PASSWORD] with the password

```bash
# Connect to Supabase via connection pooling
DATABASE_URL="postgresql://postgres.vzqpqurboxqnykvcxlke:5oPOCpB37zyGwqBz@aws-0-us-west-2.pooler.supabase.com:6543/postgres?pgbouncer=true"

# Direct connection to the database. Used for migrations
DIRECT_URL="postgresql://postgres.vzqpqurboxqnykvcxlke:5oPOCpB37zyGwqBz@aws-0-us-west-2.pooler.supabase.com:5432/postgres"
```

Add shadowDatabaseUrl url to prisma.config.ts:
...
### SK: Define your Prisma Schema

(moved up and changed)

Add model to prisma/schema.prisma file:
...
### Create the database tables and generate Prisma Client
...
```sh
# SK - moved up from the original readme
npx prisma db push

// SK: Generate Prisma Client
// - repeat after any change to the schema
npx prisma generate
```

- Local gui for local prisma database:

```bash
npx prisma studio
```

### SK: Set up Prisma Client
...
```ts
//SK: (changed) https://www.prisma.io/docs/guides/nextjs
...
### SK: Seed the database

- SK: https://www.prisma.io/docs/guides/nextjs
